...
public class ParserUtilTest {
    ...
    public void parseMatricNumber_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseMatricNumber(INVALID_MATRIC));
    }

    @Test
    public void parseMatricNumber_validValueWithoutWhitespace_returnsMatricNumber() throws Exception {
        MatricNumber expectedMatricNumber = new MatricNumber(VALID_MATRIC);
        assertEquals(expectedMatricNumber, ParserUtil.parseMatricNumber(VALID_MATRIC));
    }

    @Test
    public void parseMatricNumber_validValueWithWhitespace_returnsTrimmedMatricNumber() throws Exception {
        String matricNumberWithWhitespace = WHITESPACE + VALID_MATRIC + WHITESPACE;
        MatricNumber expectedMatricNumber = new MatricNumber(VALID_MATRIC);
